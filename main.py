...
# inputMessage = 'abc'
# print('string abc: ', sm3_result(inputMessage))
# inputMessage = 'abcd' * 16
# print('512bit \'abcd\' string : ', sm3_result(inputMessage))
...
#
# sm3 = f"{H[0]:08x}{H[1]:08x}{H[2]:08x}{H[3]:08x}{H[4]:08x}"
#
# inputMessage = './binfile.bin'
#
# print('binfile.bin SM-1: ', sm3_result(inputMessage))
#
# inputMessage = './binfile2.bin'
#
# print('binfile2.bin SM-1: ', sm3_result(inputMessage))
#
# inputMessage = './fips180-2.pdf'
#
# print('fips180-2.pdf SM-1: ', sm3_result(inputMessage))
#
# inputMessage = './LICENSE'
#
# print('LICENSE SM-1: ', sm3_result(inputMessage))
